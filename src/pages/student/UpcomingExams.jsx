...
import { Calendar, Clock, BookOpen, ExternalLink, ChevronRight, AlertCircle, Monitor, Code, UserCheck } from 'lucide-react';
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-4 mt-auto" style={{ borderTop: '1px solid #27272a' }}>
                    ...
                    <a href={exam.examLink || '#'} className="flex items-center gap-2 text-sm font-semibold hover:underline w-max" style={{ color: '#f97316' }}>
